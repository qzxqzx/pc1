...
Banner.prototype={
    ...
    bind:function bind(){
        ...
        for(var i=0;i<this.data.length;i++){
            ...
            strL+=i===0?'<li class="show"></li>':'<li></li>';
        }
    ...
    handleChange: function () {
        ...
        this.oBtnL.onclick= function () {
            if( _this.step<=0){
                ...
                utils.css( _this.oBoxInner,'left',- _this.step*1226)
            }
            _this.step--;
            animate( _this.oBoxInner,{left:- _this.step*1226});
            _this.bandTip();
        }
    }
